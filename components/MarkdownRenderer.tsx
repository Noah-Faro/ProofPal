...
const markdownStyle: MarkdownStyle = {
  ...
  h4: { color: COLORS.textPrimary, fontSize: FONT_SIZES.sm, fontWeight: '700', marginTop: SPACING.sm, marginBottom: SPACING.xs },
  h5: { color: COLORS.textPrimary, fontSize: FONT_SIZES.sm, fontWeight: '700', marginTop: SPACING.sm, marginBottom: SPACING.xs },
  h6: { color: COLORS.textPrimary, fontSize: FONT_SIZES.sm, fontWeight: '700', marginTop: SPACING.sm, marginBottom: SPACING.xs },
